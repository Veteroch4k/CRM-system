...
public record SellerDTO(
    ...
    @Size(max = 50, message = "Имя продавца не должно быть длиннее 50 символов")
    String name,

    @Schema(description = "Контактная информация продавца",
        example = "почта: ivanich@mail.ru")
    @Size(max = 1000, message = "Контактная информация избыточна: не должна превышать 1000 символов")
    String contactInfo
)
{}
